  ...
  return (
    <CardBody>
      <DetailList>
        ...
        <Detail label={i18n._(t`资源`)} value={sourceChoices[source]} />
        {organization && (
          <Detail
            label={i18n._(t`组织`)}
            value={
        ...
        {optionsList && (
          <Detail fullWidth label={i18n._(t`选项`)} value={optionsList} />
        )}
        {source_vars && (
          <VariablesDetail
      ...
      <CardActionsRow>
        ...
        {user_capabilities?.delete && (
          <DeleteButton
            name={name}
            modalTitle={i18n._(t`删除 inventory source`)}
