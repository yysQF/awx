...
function Inventory({ i18n, setBreadcrumb }) {
  ...
  const tabsArray = [
    ...
    { name: i18n._(t`详情`), link: `${match.url}/details`, id: 0 },
    { name: i18n._(t`使用权`), link: `${match.url}/access`, id: 1 },
    { name: i18n._(t`分组`), link: `${match.url}/groups`, id: 2 },
    { name: i18n._(t`主机`), link: `${match.url}/hosts`, id: 3 },
    { name: i18n._(t`资源`), link: `${match.url}/sources`, id: 4 },
    {
