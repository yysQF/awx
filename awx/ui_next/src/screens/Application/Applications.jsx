...
function Applications({ i18n }) {
  ...
  const [breadcrumbConfig, setBreadcrumbConfig] = useState({
    '/applications': i18n._(t`应用`),
    '/applications/add': i18n._(t`创建新应用`),
  });
  ...
  const buildBreadcrumbConfig = useCallback(
    application => {
      ...
      setBreadcrumbConfig({
        ...
        [`/applications/${application.id}/edit`]: i18n._(t`编辑详情`),
        [`/applications/${application.id}/details`]: i18n._(t`详情`),
        [`/applications/${application.id}/tokens`]: i18n._(t`令牌`),
      });
    },
    [i18n]
  );
