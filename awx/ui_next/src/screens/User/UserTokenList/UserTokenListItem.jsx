      ...
      <DataListItemRow>
        ...
        <DataListItemCells
          dataListCells={[
            ...
            <DataListCell
              aria-label={i18n._(t`应用名称`)}
              key="applicationName"
            >
              {token.summary_fields?.application && (
                <span>
                  <NameLabel>{i18n._(t`应用`)}</NameLabel>
                  <Link
            ...
            <DataListCell aria-label={i18n._(t`范围`)} key="scope">
              <Label>{i18n._(t`范围`)}</Label>
              {toTitleCase(token.scope)}
            </DataListCell>,
            <DataListCell aria-label={i18n._(t`到期`)} key="expiration">
