...
function JobDetail({ job, i18n }) {
  ...
  const jobTypes = {
    ...
    inventory_update: i18n._(t`库存同步`),
    job: i18n._(t`剧本运行`),
    ad_hoc_command: i18n._(t`命令行`),
    management_job: i18n._(t`作业管理`),
  ...
  return (
    <CardBody>
      <DetailList>
        ...
        <Detail label={i18n._(t`修订`)} value={job.scm_revision} />
