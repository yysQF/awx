...
function InstanceGroupList({ i18n }) {
  ...
  const pluralizedItemName = i18n._(t`实例组`);
    ...
    if (itemsUnableToDelete) {
      if (modifiedSelected.some(cannotDelete)) {
        errorMessageDelete = i18n._(
          t`You do not have permission to delete : ${itemsUnableToDelete}. `
        );
      }
    }
  ...
  const addContainerGroup = i18n._(t`添加容器组`);
  const addInstanceGroup = i18n._(t`添加实例组`);
              ...
              <DatalistToolbar
                ...
                additionalControls={[
                  ...
                  <ToolbarDeleteButton
                    ...
                    pluralizedItemName={i18n._(t`实例组`)}
